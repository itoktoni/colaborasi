...
class CMS
{
    ...
    const VOUCHER_ONETIMEUSAGE = 1;
    const VOUCHER_TIMELINE = 2;
    const VOUCHER_COUNTERBASED = 3;
    const STATUS_INACTIVE = 0;
    const STATUS_ACTIVE = 1;
    const STATUS_DELETED = -9;
    const TOPUP_REJECTED = -1;
    const TOPUP_WAITING = 0;
    const TOPUP_USER_CONFIRMED = 1;
    const TOPUP_ADMIN_CONFIRMED = 2;
    const TOPUP_FINISH = 3;
    const REVIEW_ACCEPTED = 1;
    const REVIEW_WAITING = 0;
    const REVIEW_DELETED = -9;
    const PAYMENT_BALANCE = 2;
    const PAYMENT_PAYPAL = 1;
    const PAYMENT_CC = 3;
    const BANK_BCA = 1;
    const BANK_MANDIRI = 2;
    const SHIPPING_ON = 1;
    const SHIPPING_OFF = 0;
    ...
    const CONTENT_MUSIC = 2;
    const CONTENT_IMAGE = 3;
    const SOURCE_TYPE_EMBED = 1;
    const SOURCE_TYPE_SERVER = 2;
    const SOCIAL_MEDIA_TYPE_FACEBOOK = 1;
    const SOCIAL_MEDIA_TYPE_TWITTER = 2;
    const SOCIAL_MEDIA_TYPE_GOOGLE = 3;
    const SOCIAL_MEDIA_TYPE_GITHUB = 4;
    ...
    {
        return (isset(CMS::discount_type()[$type])) ? CMS::discount_type()[$type] : '';
    }
