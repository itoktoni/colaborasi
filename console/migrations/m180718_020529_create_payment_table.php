...
class m180718_020529_create_payment_table extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable('payment', [
            ...
            'voucher_discount_value' => $this->decimal(10,2),
            'tax_amount' => $this->integer(),
            'total_bruto' => $this->decimal(10,2),
            'total_bruto_dollar' => $this->decimal(10,2),
            'total_discount_rupiah' => $this->decimal(10,2),
            'total_discount_dollar' => $this->decimal(10,2),
            'total_tax_rupiah' => $this->decimal(10,2),
            'total_tax_dollar' => $this->decimal(10,2),
            'total_shipping_rupiah' => $this->decimal(10,2),
            'total_shipping_dollar' => $this->decimal(10,2),
            'total_net_rupiah' => $this->decimal(10,2),
            'total_net_dollar' => $this->decimal(10,2),
            ...
            'shipping_receiver' => $this->string(),
            'shipping_address' => $this->string(),
            'shipping_phone_number' => $this->string(),
        ...
        $this->createTable('payment_detail', [
            ...
            'product_origin_price' => $this->decimal(10,2),
            'product_discount_price' => $this->decimal(10,2),
            'product_sell_price' => $this->decimal(10,2),
            'status' => $this->tinyinteger()
        ]);
