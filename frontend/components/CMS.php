...
class CMS
{
    ...
    const TOPUP_FINISH = 1;
    const TOPUP_NEED_CONFIRMATION = '0';
    const TOPUP_EXPIRED = -9;

    public static function getStatusTopUp($var)
    {
        return (isset(self::topupStatus()[$var])) ? self::topupStatus()[$var] : false;
    }

    public static function topupStatus()
    {
        return [self::TOPUP_NEED_CONFIRMATION => 'Waiting Confirmation', self::TOPUP_FINISH => 'Completed', self::TOPUP_EXPIRED => 'Expired'];
    }
