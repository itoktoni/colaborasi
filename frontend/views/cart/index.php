								...
								<tr class="table-row">
									<td class="column-1">
										<div class="cart-img-product b-rad-4 o-f-hidden">
											<a href="<?php echo Url::to('product/'.$item['slug'], true); ?>"><img src="<?php echo $item['image']; ?>" alt="IMG-PRODUCT"></a>
										</div>
									</td>
									...
									<td class="column-5">
										<a class="cart-delete" href="<?php echo Url::to('/cart/delete/'.$item['id']); ?>"><i class="up-mark fs-20 color1 fa fa-close" aria-hidden="true"></i></a>
									</td>
								</tr>
